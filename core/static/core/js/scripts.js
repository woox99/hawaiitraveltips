(function ($) {
  ...
  ****************************************************/
  if ($(".togo-mobile-menu").length && $(".togo-mobilemenu-content").length) {
    ...
    // ===============================
    $(".togo-mobilemenu-content .togo-dropdown").each(function () {
      let li = $(this);
      li.addClass("dropdown-opened");                 // mark li as opened
      li.children("a").addClass("expanded");          // mark the <a> as expanded
      li.children(".mobile-slide").show();            // make submenu visible
      li.find(".dropdown-toggle-btn").addClass("dropdown-opened"); // arrow icon
    });
  }
